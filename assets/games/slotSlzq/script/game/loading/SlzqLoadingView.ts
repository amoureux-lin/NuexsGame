...
@ccclass('SlzqLoadingView')
export class SlzqLoadingView extends BaseLoadingView {

    onLoad() {
        console.log('SlzqLoadingView.onLoad');
        super.onLoad();
    }
    ...
    protected override stageRanges: Record<LoadingStage, [number, number]> = {
        [LoadingStage.COMMON_RESOURCES]: [0,  22],
        [LoadingStage.I18N]:             [22, 25],
