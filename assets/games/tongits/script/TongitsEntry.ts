...
import { slotGameUI, SlotGameUIPanelConfig } from './config/TongitsUIConfig';
import { SlotGameController } from './game/TongitsController';
import { SlotGameModel } from './game/TongitsModel';
